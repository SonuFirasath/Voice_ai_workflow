...
async function run() {
  ...
  if (hits.length > 0) {
    ...
    console.log(
      "✅ SUCCESS — This is exactly what VAPI's GPT-4o will receive as context.",
    );
  } else {
  ...
  const folders = {
    General_Policies: generalFolder,
    Manager_Policies: managerFolder,
    Sales_Policies: salesFolder,
  };
